...
MODNAME=" "
#MODNAME+="coremod.ko"
#MODNAME+="san_leds.ko " #"san_mod.ko"
# MODNAME+="ssd1306_drv.ko "
MODNAME+="ssd1306_SanB.ko"
        ...
        case $1 in
           -h|--help)
            ...
            --deploy)
                ...
                #echo $DTBNAME
                sshpass -p "temppwd" scp $MODNAME $DTBNAME debian@192.168.7.2:~/
                echo "+ Uploaded to BB: $MODNAME"
                echo "+ Uploaded to BB: $DTBNAME"
                ;;
            --kconfig)
